...
#define USBD_MANUFACTURER_STRING     "Rubik Solver"
#define USBD_PID     0x5740
#define USBD_PRODUCT_STRING     "URS Motor Controller"
#define USBD_CONFIGURATION_STRING     "URS CDC Config"
#define USBD_INTERFACE_STRING     "URS Command Interface"
